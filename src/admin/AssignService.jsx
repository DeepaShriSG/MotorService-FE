...
function AssignService() {
  ...
  const getData = async () => {
    ...
    try {
      const res = await AxiosService.get(`/getService/${params.id}`);
     ...
     >
       {({ values,errors,touched,handleBlur,handleSubmit,handleChange})=>(
         ...
         <Form.Group className="mb-3">
             ...
             <Form.Control type="text" value = {values.userId} name='userId' placeholder="Enter userId" onBlur={handleBlur} onChange={handleChange} disabled/>
